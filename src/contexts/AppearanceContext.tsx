...
const DEFAULT_SETTINGS: AppearanceSettings = {
    theme: 'classic',
    museumName: 'Archive Database',
    museumShortName: 'Archive',
    contactSupportUrl: "",
    archiveFeedbackUrl: "",
    suggestionBoxUrl: "",
    ...
    showLibraryNotice: false,
    libraryNoticeText: "Books in our collection are reference-only and are currently not available for check out.",
    heroTitle: 'Archive\nDatabase',
